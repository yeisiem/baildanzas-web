      ...
      for (const [hora, lista] of Object.entries(porHora)) {
        ...
        if (found)
          return {
            ...
            dia,
            hora,
            nombre: found.nivel ? `${found.nombre} \xB7 ${found.nivel}` : found.nombre,
            tipo: "activa"
          };
      }
    }
...
var semillaHorario = () => ({
  Lunes: {
    ...
    "18:30": [{ id: uid(), nombre: "Baile en l\xEDnea", nivel: "" }],
    "19:30": [{ id: uid(), nombre: "Flamenco", nivel: "" }],
    "20:30": [{ id: uid(), nombre: "Bailes de sal\xF3n", nivel: "" }],
  ...
  Mi\u00E9rcoles: {
    "10:30": [{ id: uid(), nombre: "Baile en l\xEDnea", nivel: "" }],
    "11:30": [{ id: uid(), nombre: "Baile en l\xEDnea", nivel: "" }],
    "12:30": [{ id: uid(), nombre: "Pilates", nivel: "" }],
  ...
  Viernes: {
    ...
    "18:30": [{ id: uid(), nombre: "Bailes de sal\xF3n", nivel: "Avanzado" }],
    "19:30": [{ id: uid(), nombre: "Bailes de sal\xF3n", nivel: "Iniciaci\xF3n" }],
    "20:30": [{ id: uid(), nombre: "Bailes de sal\xF3n", nivel: "Intermedio" }]
  },
  S\u00E1bado: {},
  Domingo: {}
});
...
function Baildanzas() {
  ...
  const unirseAPropuesta = (personas) => {
    ...
    if (antes < UMBRAL_PROPUESTA && despues >= UMBRAL_PROPUESTA) {
      notificar(nuevo, {
        ...
        hora: info.hora,
        nombre: info.nombreActividad,
        tipo: `\xA1Umbral alcanzado! (${despues} personas)`,
        contactos: nuevo.interesados[info.activityId],
        ts: Date.now(),
        resuelto: false
      });
      mostrarToast(`\xA1Sois ${despues}! Avisaremos al equipo para organizar la clase.`);
    } else {
      mostrarToast(
        `\xA1Apuntados! Sois ${despues} de ${UMBRAL_PROPUESTA} para que la clase arranque.`
      );
    }
    persistir(nuevo);
    setModal(null);
  ...
  const proponerYSugerir = (listaActividades, listaSugerencias, personas) => {
    ...
    mostrarToast(`\xA1Listo! ${partes.join(" y ")} registradas para ${personas.length} persona${personas.length > 1 ? "s" : ""}.`);
    setModal(null);
  };
  ...
  const anadirActividadBase = (dia2, hora, nombreActividad, nivel, cupo, horaFin, sala) => {
    ...
    persistir(nuevo);
    mostrarToast(
      `\xA1A\xF1adido! "${nombreActividad}" el ${dia2.toLowerCase()} a las ${hora}${horaFin ? `\u2013${horaFin}` : ""}${sala ? ` (${sala})` : ""} en ${nuevo.sedes[sedeId].nombre}.`
    );
  };
  ...
  const aprobarSugerencia = (sugerenciaId) => {
    ...
    if (totalInteresados >= UMBRAL_PROPUESTA) {
      notificar(nuevo, {
        ...
        hora: s.hora,
        nombre: s.nombre,
        tipo: `\xA1Umbral alcanzado! (${totalInteresados} personas)`,
  ...
  const quitarInteresado = (activityId, idxPersona, origen = "interesados") => {
    ...
    if (loc && loc.tipo === "activa" && (nuevo.listaEspera[activityId] || []).length > 0) {
      ...
      if (cupo == null || nuevo.interesados[activityId].length < cupo) {
        ...
        notificar(nuevo, {
          ...
          hora: loc.hora,
          nombre: loc.nombre,
          tipo: "Se liber\xF3 un hueco: promocionada desde lista de espera",
    ...
    persistir(nuevo);
    mostrarToast(
      promocionado ? `Baja hecha. ${promocionado.nombre} pasa de la lista de espera a apuntado/a \u2014 av\xEDsale.` : "Inscripci\xF3n dada de baja correctamente."
    );
  };
  ...
  const convertirEnClaseActiva = (dia2, hora, propuestaId, nombreActividad, sala) => {
    ...
    persistir(nuevo);
    mostrarToast(
      personasTransferidas.length > 0 ? `\xA1Hecho! "${nombreActividad}" ya es una clase activa, con ${personasTransferidas.length} alumnos ya apuntados.` : `\xA1Hecho! "${nombreActividad}" ya es una clase activa los ${dia2.toLowerCase()} a las ${hora}.`
    );
  };
  const anadirAlumnoActiva = (dia2, hora, activityId, nombre, telefono) => {
    ...
    persistir(nuevo);
    mostrarToast(`${nombre} a\xF1adido/a a la clase.`);
  };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: PAL.papel, fontFamily: FONT.body, color: PAL.tinta }, className: "min-h-screen pb-24" }, /* @__PURE__ */ React.createElement(FontImport, null), /* @__PURE__ */ React.createElement(
    ...
    if (sala && horas.length === 0) {
      return /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.4 }, className: "text-sm text-center py-10" }, "Este d\xEDa, ", sala.toLowerCase(), " est\xE1 cerrada.");
    }
...
function FilaHora({ hora, dia, activas, propuestas, estado, onAbrirModal }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex gap-3 items-start" }, /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        onClick: () => onAbrirModal({
          ...
          activityId: act.id,
          cupo: act.cupo,
          nombreActividad: act.nivel ? `${act.nombre} \xB7 ${act.nivel}` : act.nombre
        }),
    ...
    /* @__PURE__ */ React.createElement("span", { className: "text-[15px]" }, vacio ? "Libre \u2014 prop\xF3n algo aqu\xED" : "Proponer otra actividad aqu\xED")
  )));
}
  ...
  if (confirmando) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: FONT.display, color: PAL.tinta }, className: "text-2xl font-medium mb-1" }, "\xBFRevisamos los datos?"),
        /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.6 }, className: "text-sm mb-5" }, "Comprueba que est\xE1 todo bien escrito antes de enviarlo \u2014 sobre todo el tel\xE9fono."),
        /* @__PURE__ */ React.createElement("div", { style: { background: PAL.blanco, border: `1px solid ${PAL.linea}` }, className: "rounded-2xl p-4 mb-5" }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, color: PAL.tinta, opacity: 0.5 }, className: "text-[11px] uppercase tracking-widest mb-2" }, info.dia, " \xB7 ", info.hora, info.sala ? ` \xB7 ${info.sala}` : ""), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-4" }, nombresActividades.map((n, i) => /* @__PURE__ */ React.createElement(
          "span",
          {
            key: i,
    ...
    /* @__PURE__ */ React.createElement(
      ...
      info.modo === "vacio" && /* @__PURE__ */ React.createElement("div", { className: "mb-5" }, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.75 }, className: "text-sm mb-3 leading-relaxed" }, "\xBFQu\xE9 actividad te gustar\xEDa hacer aqu\xED? Puedes a\xF1adir m\xE1s de una si te vale cualquiera de ellas."), listaActividades.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-2" }, listaActividades.map((a) => /* @__PURE__ */ React.createElement(
        ...
        "button",
        {
          ...
          title: "A\xF1adir otra actividad"
        },
        /* @__PURE__ */ React.createElement(Plus, { size: 16 })
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.6 }, className: "text-xs mb-2" }, personas.length === 0 ? "Tus datos \u2014 y si quieres apuntar a m\xE1s gente contigo, a\xF1\xE1delos tambi\xE9n" : "A\xF1ade a la siguiente persona"), personas.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-2.5" }, personas.map((p, i) => /* @__PURE__ */ React.createElement(
        "span",
        {
          key: i,
      ...
      ))), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement(Campo, { icon: /* @__PURE__ */ React.createElement(User, { size: 14 }), valor: nombre, onCambio: setNombre, placeholder: "Nombre de pila" }), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Campo, { icon: /* @__PURE__ */ React.createElement(Phone, { size: 14 }), valor: telefono, onCambio: setTelefono, placeholder: "Tel\xE9fono (con prefijo si es extranjero, ej. +34)", tipo: "tel" }), /* @__PURE__ */ React.createElement(
        "button",
        {
          ...
          className: "px-3.5 rounded-xl border shrink-0",
          title: "A\xF1adir a otra persona"
        },
        /* @__PURE__ */ React.createElement(Plus, { size: 16 })
      )), telefono.trim().length > 0 && !telefonoValido(telefono) && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.carmin, opacity: 0.7 }, className: "text-[11px]" }, "El tel\xE9fono debe tener al menos 9 d\xEDgitos (se admite el prefijo internacional, ej. +34).")), /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.4 }, className: "text-[11px] mt-2" }, "\xBFVienen amigos y/o hijos contigo? A\xF1\xE1delos uno a uno con su nombre \u2014 puedes repetir el mismo tel\xE9fono si es el contacto familiar.")),
      (() => {
...
function PanelGestion({
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(36,30,49,0.45)" }, className: "fixed inset-0 z-50 flex justify-end" }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-1" }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: FONT.display, color: PAL.tinta }, className: "text-2xl font-medium" }, "Panel de gesti\xF3n"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: onExportar,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-5 flex-wrap" }, [
      ...
      ["catalogo", "Cat\xE1logo", null, PAL.carmin, 0]
      ...
      !!badgeExtra && /* @__PURE__ */ React.createElement(
        "span",
        {
          ...
          title: "Nuevas desde la \xFAltima vez que entraste"
        },
        badgeExtra
      ),
      label,
    ...
    tab === "avisos" && /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, pendientes.length === 0 && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-sm" }, "No hay avisos pendientes. Aqu\xED ver\xE1s cu\xE1ndo alguien se apunta o cu\xE1ndo una propuesta llega a ", UMBRAL_PROPUESTA, " personas."), pendientes.map((a) => /* @__PURE__ */ React.createElement("div", { key: a.id, style: { background: PAL.blanco, border: `1px solid ${PAL.linea}` }, className: "p-4 rounded-2xl" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.display }, className: "font-medium text-sm" }, a.nombre), /* @__PURE__ */ React.createElement("div", { style: { color: PAL.carmin }, className: "text-xs mt-0.5" }, a.tipo), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, opacity: 0.5 }, className: "text-[10px] mt-1" }, a.dia, " \xB7 ", a.hora)), /* @__PURE__ */ React.createElement("button", { onClick: () => onResolver(a.id), style: { color: PAL.petroleo }, className: "p-1.5 shrink-0" }, /* @__PURE__ */ React.createElement(Check, { size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "mt-2" }, (a.contactos || (a.contacto ? [a.contacto] : [])).map((c, i) => /* @__PURE__ */ React.createElement(FilaPersona, { key: i, nombre: c.nombre, telefono: c.telefono, ts: c.ts }))))), resueltos.length > 0 && /* @__PURE__ */ React.createElement("details", { className: "pt-2" }, /* @__PURE__ */ React.createElement("summary", { style: { color: PAL.tinta, opacity: 0.4 }, className: "text-xs cursor-pointer" }, "Resueltos (", resueltos.length, ")"), /* @__PURE__ */ React.createElement("div", { className: "mt-2 space-y-2" }, resueltos.map((a) => /* @__PURE__ */ React.createElement("div", { key: a.id, style: { opacity: 0.45 }, className: "text-xs" }, a.nombre, " \u2014 ", a.dia, " ", a.hora))))),
    tab === "buscar" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-xs mb-3" }, "Busca por el nombre o el tel\xE9fono que os haya dado la persona para ver en qu\xE9 est\xE1 apuntada (en cualquiera de las dos sedes) y darla de baja si os lo pide."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-4" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        ...
        placeholder: "Nombre o tel\xE9fono\u2026",
        type: "text",
      ...
      "Buscar"
    )), resultadosBusqueda !== null && resultadosBusqueda.length === 0 && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-sm" }, "No hay ninguna inscripci\xF3n con ese tel\xE9fono."), /* @__PURE__ */ React.createElement("div", { className: "space-y-2.5" }, (resultadosBusqueda || []).map((r) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        ), editando.nombre.trim().length > 1 && !telefonoValido(editando.telefono) && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.carmin }, className: "text-[11px]" }, "El tel\xE9fono debe tener al menos 9 d\xEDgitos."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(
          "button",
          {
        ...
        ), /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { style: { color: PAL.tinta }, className: "text-sm font-medium truncate" }, r.persona.nombre), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, color: PAL.tinta, opacity: 0.55 }, className: "text-[11px] truncate" }, r.persona.telefono, r.persona.ts && /* @__PURE__ */ React.createElement("span", { className: "opacity-70" }, " \xB7 ", formatearFechaHora(r.persona.ts))))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 shrink-0" }, /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: () => setEditando({
            ...
            title: "Corregir nombre o tel\xE9fono"
          },
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("span", { style: { color: PAL.tinta, opacity: 0.45 }, className: "text-xs" }, "\xB7 ", r.sedeNombre, " \xB7 ", r.dia, " ", r.hora),
          /* @__PURE__ */ React.createElement(
            "span",
            {
    ...
    tab === "horario" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { background: PAL.blanco, border: `1px solid ${PAL.linea}` }, className: "p-4 rounded-2xl mb-5" }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, opacity: 0.5 }, className: "text-[11px] uppercase tracking-widest mb-3" }, "A\xF1adir clase fija"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2 mb-2" }, /* @__PURE__ */ React.createElement("select", { value: nDia, onChange: (e) => setNDia(e.target.value), className: "px-3 py-2 rounded-lg border text-sm", style: { borderColor: PAL.linea } }, diasSede.map((d) => /* @__PURE__ */ React.createElement("option", { key: d }, d))), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: nNombre,
      ...
      "input",
      {
        ...
        placeholder: "Nivel o edad (ej: 3 a 5 a\xF1os) \u2014 opcional",
        className: "w-full px-3 py-2 rounded-lg border text-sm mb-2",
        style: { borderColor: PAL.linea }
      }
    ), /* @__PURE__ */ React.createElement(
      "input",
      {
        ...
        placeholder: "Cupo m\xE1ximo (opcional)",
        inputMode: "numeric",
      ...
      return /* @__PURE__ */ React.createElement("div", { key: d }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, opacity: 0.5 }, className: "text-[11px] uppercase tracking-widest mt-3 mb-1" }, d), horasDelDia.sort().map(
        (h) => sede.activas[d][h].map((act) => {
          ...
          return /* @__PURE__ */ React.createElement("div", { key: act.id, className: "py-1.5" }, /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement("span", { className: "min-w-0" }, h, act.horaFin ? `\u2013${act.horaFin}` : "", " \u2014 ", act.nombre, " ", act.nivel && /* @__PURE__ */ React.createElement("em", { style: { opacity: 0.6 } }, "(", act.nivel, ")"), act.sala && /* @__PURE__ */ React.createElement("span", { style: { color: PAL.morado, opacity: 0.8 }, className: "text-xs" }, " \xB7 ", act.sala)),
            /* @__PURE__ */ React.createElement(
              "span",
              {
                style: { fontFamily: FONT.mono, color: PAL.petroleo },
            ...
            "input",
            {
              ...
              placeholder: "cupo",
              inputMode: "numeric",
              title: "Cupo m\xE1ximo (vac\xEDo = sin l\xEDmite)",
              className: "w-16 px-1.5 py-1 rounded-md border text-xs text-center",
              style: { borderColor: PAL.linea, background: PAL.blanco }
            }
          ), /* @__PURE__ */ React.createElement("span", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-[11px]" }, "cupo m\xE1ximo (vac\xEDo = sin l\xEDmite)"), /* @__PURE__ */ React.createElement(
            "button",
            {
          ...
          ))) : /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.4 }, className: "text-xs mb-2" }, "Todav\xEDa no hay alumnado apuntado en esta clase."), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, /* @__PURE__ */ React.createElement(
            "input",
            {
            ...
            "button",
            {
              ...
              title: "A\xF1adir a esta clase"
            },
            /* @__PURE__ */ React.createElement(Plus, { size: 14 }),
            " A\xF1adir a la clase"
          ))));
        })
      ));
    }))),
    tab === "propuestas" && /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-xs mb-1" }, "Todas las propuestas abiertas del cat\xE1logo, con qui\xE9n se ha apuntado a cada una."), listaPropuestas.length === 0 && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-sm" }, "No hay ninguna propuesta abierta ahora mismo."), listaPropuestas.slice().sort((a, b) => b.ultimoTs - a.ultimoTs).map((p) => {
      const duplicados = grupoDuplicado(p).filter((d) => d.id !== p.id);
      return /* @__PURE__ */ React.createElement("div", { key: p.id, style: { background: PAL.blanco, border: `1.5px dashed ${PAL.mostaza}` }, className: "p-4 rounded-2xl" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-2 mb-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.display }, className: "font-medium text-sm" }, p.nombre), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, opacity: 0.5 }, className: "text-[10px] mt-1" }, p.dia, " \xB7 ", p.hora, p.sala ? ` \xB7 ${p.sala}` : "")), /* @__PURE__ */ React.createElement(DotsProgreso, { n: p.personas.length })), duplicados.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { background: PAL.papel, border: `1px solid ${PAL.carmin}` }, className: "rounded-xl p-2.5 mb-3" }, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.carmin }, className: "text-[11px] mb-1.5" }, "Hay ", duplicados.length + 1, ' propuestas de "', p.nombre, '" en este mismo hueco \u2014 probablemente por error.'), /* @__PURE__ */ React.createElement(
        "button",
        {
        ...
        ")"
      )), p.personas.length === 0 ? /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.4 }, className: "text-xs" }, "Nadie apuntado todav\xEDa.") : /* @__PURE__ */ React.createElement("div", null, p.personas.map((persona, idx) => /* @__PURE__ */ React.createElement(
        FilaPersona,
        {
          key: idx,
...
\xA1Nos vemos en Baildanzas! \u{1F483}\u{1F389}`;
    ...
    tab === "catalogo" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.5 }, className: "text-xs mb-3" }, "Estas son las actividades que la gente puede elegir al proponer algo en un hueco libre."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-4" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        ...
        placeholder: "Nueva actividad del cat\xE1logo",
        className: "flex-1 px-3 py-2 rounded-lg border text-sm",
        style: { borderColor: PAL.linea }
      }
    ), /* @__PURE__ */ React.createElement(
...
function FilaPersona({ nombre, telefono, ts, onQuitar, tituloQuitar, onGuardarEdicion }) {
  ...
  if (editando) {
    ...
    ), n.trim().length > 1 && !telefonoValido(t) && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.carmin }, className: "text-[11px]" }, "El tel\xE9fono debe tener al menos 9 d\xEDgitos."), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          setEditando(false);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { style: { color: PAL.tinta }, className: "text-sm font-medium truncate" }, nombre), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: FONT.mono, color: PAL.tinta, opacity: 0.55 }, className: "text-[11px] truncate" }, telefono, ts && /* @__PURE__ */ React.createElement("span", { className: "opacity-70" }, " \xB7 ", formatearFechaHora(ts))))),
    /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-0.5 shrink-0" }, onGuardarEdicion && /* @__PURE__ */ React.createElement("button", { onClick: () => setEditando(true), style: { color: PAL.morado, opacity: 0.65 }, className: "p-1.5", title: "Corregir nombre o tel\xE9fono" }, /* @__PURE__ */ React.createElement(Pencil, { size: 13 })), onQuitar && /* @__PURE__ */ React.createElement("button", { onClick: onQuitar, style: { color: PAL.carmin, opacity: 0.55 }, className: "p-1.5", title: tituloQuitar }, /* @__PURE__ */ React.createElement(Trash2, { size: 14 })))
  );
}
...
function CandadoPIN({ onCerrar, onDesbloquear }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.6 }, className: "text-sm text-center mb-5" }, "Introduce el PIN para entrar al panel de gesti\xF3n."),
      /* @__PURE__ */ React.createElement(
        "input",
        {
          value: pin,
      ...
      error && /* @__PURE__ */ React.createElement("p", { style: { color: PAL.carmin }, className: "text-xs text-center mb-2" }, "PIN incorrecto, int\xE9ntalo de nuevo."),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: comprobar,
