...
function ModalHueco({ info, estado, catalogo, onCerrar, onUnirseActiva, onUnirsePropuesta, onEnviarHueco }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { color: PAL.tinta, opacity: 0.6 }, className: "text-xs mb-2" }, personas.length === 0 ? "Tus datos — y si quieres apuntar a más gente contigo, añádelos también" : "Añade a la siguiente persona"), personas.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-2.5" }, personas.map((p, i) => /* @__PURE__ */ React.createElement(
        "span",
        {
          key: i,
